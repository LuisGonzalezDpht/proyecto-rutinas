<template>
  <div class="w-full grid justify-center">
    ...
    <div
      v-else
      class="select-text bg-neutral-100 md:dark:bg-neutral-900 dark:bg-neutral-950 md:p-10 p-5 md:rounded-lg drop-shadow-2xl transition-all duration-200 ease-in-out"
      v-html="htmlContent"
    ></div>
  </div>
</template>
